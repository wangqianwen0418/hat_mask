...
check_point = keras.callbacks.ModelCheckpoint("vgg_model/vgg_model_{}.h5".format(exp), monitor='val_acc', verbose=0, save_best_only=True, save_weights_only=False)
tf_log = keras.callbacks.TensorBoard(log_dir='vgg_model/tf_logs_{}'.format(exp), batch_size=batch_size, write_graph=True)
